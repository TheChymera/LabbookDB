from common_classes import Animal, Genotype, Treatment, session
...
SSRI = Treatment(substance="Fluoxetine", frequency="daily", administration="intraperitoneal")
placebo = Treatment(substance="placebo", frequency="daily", administration="intraperitoneal")
